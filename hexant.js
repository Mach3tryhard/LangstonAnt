...
const gridSizeControl = fisier3
  .add(obj, "ZoomLevel", 1, 20)
  .onChange(() => redrawGrid());
...
function redrawGrid() {
  ...
  state.forEach((colorIndex, key) => {
    ...
    if (
      x > -obj.ZoomLevel * 2 &&
      x < canvas.width + obj.ZoomLevel * 2 &&
      y > -obj.ZoomLevel * 2 &&
      y < canvas.height + obj.ZoomLevel * 2
    ) {
...
function update() {
  ...
  if (step > 1000000000 && step % 1000000 == 0)
    obj.Iteration = step / 1000000000 + "B";
  else if (step > 1000000 && step % 1000 == 0)
    obj.Iteration = step / 1000000 + "M";
  else if (step > 1000 && step % 1000 == 0) obj.Iteration = step / 1000 + "K";
  else if (step > 0 && step <= 1000) obj.Iteration = step;
